...
export const Button: React.FC<ButtonProps> = ({
  ...
  if (variant === "page") {
    return (
      <button
        onClick={handleClick}
        className="text-sm underline transition-colors text-heading underline-offset-4 decoration-zinc-300 dark:decoration-zinc-600 hover:decoration-zinc-900 dark:hover:decoration-zinc-100 w-fit"
      >
        {text}
      </button>
    );
