...
// ── Shared static text ────────────────────────────────────────────────────────
const HeroContent = () => (
  <div className="absolute left-0 z-10 w-full max-w-4xl px-6 bottom-56 md:bottom-16 lg:bottom-72 md:px-12 lg:px-20">
    {/* Eyebrow */}
    <span className="uppercase tracking-[0.4em] text-amber-400 text-xs md:text-sm font-semibold">
      Event Chef
    </span>
...
const HeroMobile = () => (
  <section className="relative h-[100svh] w-full">
    ...
    />
    <div className="absolute inset-0 pointer-events-none dark:bg-gradient-to-b dark:from-zinc-950/0 via-transparent dark:to-zinc-950" />
