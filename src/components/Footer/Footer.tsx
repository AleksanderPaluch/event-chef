...
export const Footer = () => {
  return (
    <footer className="w-full px-4 py-16 border-t border-zinc-200 dark:border-zinc-800">
      <div className="flex flex-col max-w-2xl gap-10 mx-auto lg:max-w-3xl">
        <p className="text-lg lg:text-xl text-center uppercase tracking-[0.25em] pb-2 opacity-90">
          Event Chef
        </p>


<div className="flex flex-col items-center w-full max-w-3xl gap-6 px-12 md:flex-row">
   <div className="flex flex-col gap-4 ">
        ...
        <div className="w-12 h-px mx-auto mr-24 lg:mr-48 md:w-px md:h-12 bg-amber-500 dark:bg-amber-400" />
        ...
        <p className="text-xs text-center lg:text-xs font-semibold uppercase tracking-[0.2em] py-4 opacity-30 px-8">
