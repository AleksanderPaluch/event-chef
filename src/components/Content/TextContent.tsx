...
export const TextContent: React.FC<TextContentProps> = ({
  ...
  return (
    <Motion>
      <div className="py-4 px-4 md:py-10 lg:py-20 md:px-12  lg:px-16 mb-12  md:mb-16 md:mt-8 lg:mb-28 lg:mt-10     md:max-w-[90%]  lg:max-w-7xl  gap-8 md:gap-20 bg-zinc-900/20 rounded-3xl flex flex-col mx-auto">
        {stats ? (
          <Testimonials />
        ) : (
          <>
